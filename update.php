            ...
            <div class="tab-pane fade show active" id="viewitem" role="tabpanel" aria-labelledby="home-tab">
                        <form action="" method="post" enctype="multipart/form-data">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="cost"  value="<?php if(isset($rcost)) { echo $rcost;}?>" placeholder="Enter Price" name="cost" required>
                                     </div>
	                                ...
	                                <div class="form-group">
                                         ...
                                         <input type="file" accept="image/*" name="food_pic"/>Food Image 
                                    </div>
