    ...
    if(isset($_SESSION['id']))
{
	...
	(fld_name,fld_email,fld_password,fld_mob,fld_tin,fld_address,fld_logo)
       	values('$r_name','$email','$pswd','$mob','$tin','$address','$logo')");
	       ...
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" value="<?php if(isset($r_name)) { echo $r_name;}?>" placeholder="Enter FastFood Name" name="r_name" required/>
                      </div>
	                  <div class="form-group">
                    ...
                    <div class="form-group">
                          ...
                          <input type="tel" class="form-control" id="tin" value="<?php if(isset($tin)) { echo $tin;}?>" placeholder="Eg.(123-456-789-000)" name="tin" required>
                     </div>
	                 <div class="form-group">
