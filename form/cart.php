      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
          ...
          <?php
			...
			{
			?>
			<a href="cart.php"><span style="color:red; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:red;" id="cart"  class="badge badge-light"><?php if(isset($re)) echo $re; ?></span></i></span></a>
                 ...
                 <table class="table">
                  <tbody>
	               <?php
	                ...
	                ?>
                      <tr>
                          <td><image src="../image/restaurant/<?php echo $em."/foodimages/".$res['fldimage'];?>" height="80px" width="100px"></image></td>
                         <td><?php echo $res['foodname'];?></td>
                         <td><?php echo $res['cost'];?></td>
                         <td><?php echo $res['cuisines'];?></td>
                         <td><?php echo $nm; ?></td>
		                <form method="post" enctype="multipart/form-data">
                           <td><button type="submit" name="del"  value="<?php echo $res['fld_cart_id']?>" class="btn btn-danger">Remove</button></td>
                        </form>
                   ...
                   <?php
					  ...
					  <td style="padding:30px; text-align:center;">
                        <a href="../index.php"><button type="button" style=" color:white; font-weight:bold; text-transform:uppercase;" class="btn btn-warning">Add More Item</button></a>
